...
public class PenguinEntity extends BirdEntity implements BirdBrain<PenguinEntity> {
    ...
    protected float getStandingEyeHeight(Pose pose, EntityDimensions dimensions) {
        return this.getPose() == Pose.LONG_JUMPING || this.getPose() == Pose.SWIMMING ? 0.4f : 1.35f;
    }
    ...
    public float getSpeed() {
        return this.getPose() == Pose.LONG_JUMPING ? super.getSpeed() * 1.5F : super.getSpeed();
    }
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(LAST_POSE_TICK, LAST_POSE_CHANGE_TICKS);
    }
    ...
    protected void positionRider(Entity passenger, MoveFunction positionUpdater) {
        ...
        Vec3 vec3d = new Vec3(this.getMountedXOffset(), 0.0, 0.0).yRot(-this.getYRot() * (float) (Math.PI / 180.0) - (float) (Math.PI / 2));
    ...
    public float maxUpStep() {
        return this.getPose() == Pose.LONG_JUMPING ? 1.1F : super.maxUpStep();
    }
    ...
    public EntityDimensions getDimensions(Pose pose) {
        ...
        return pose == Pose.LONG_JUMPING || pose == Pose.SWIMMING ? dimensions.scale(1.0F, 0.35F) : dimensions;
    }
