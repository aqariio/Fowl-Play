...
public class RobinEntity extends FlyingBirdEntity implements BirdBrain<RobinEntity>, VariantHolder<RobinEntity.Variant> {
    ...
    @Override
    public ActivityGroup<? extends RobinEntity> getCoreTasks() {
    ...
    @Override
    public ActivityGroup<? extends RobinEntity> getAvoidTasks() {
    ...
    @Override
    public ActivityGroup<? extends RobinEntity> getForageTasks() {
    ...
    @Override
    public ActivityGroup<? extends RobinEntity> getPerchTasks() {
    ...
    @Override
    public ActivityGroup<? extends RobinEntity> getPickupFoodTasks() {
    ...
    @Override
    public ActivityGroup<? extends RobinEntity> getRestTasks() {
