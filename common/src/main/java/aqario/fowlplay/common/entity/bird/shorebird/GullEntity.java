...
public class GullEntity extends TrustingBirdEntity implements BirdBrain<GullEntity>, VariantHolder<GullVariant> {
    ...
    @Override
    public CommonRegistry<GullVariant> variantRegistry() {
        return FPBuiltInRegistries.GULL_VARIANT.get();
    }
    ...
    @Override
    public GullVariant defaultVariant() {
        return GullVariant.HERRING.get();
    }
