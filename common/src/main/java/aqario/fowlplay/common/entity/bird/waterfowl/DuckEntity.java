...
public class DuckEntity extends TrustingBirdEntity implements BirdBrain<DuckEntity>, VariantHolder<DuckVariant>, Domesticatable, Flocking {
    ...
    public @Nullable AgeableMob getBreedOffspring(ServerLevel level, AgeableMob otherParent) {
        ...
        if(child != null && otherParent instanceof DuckEntity parent2) {
            DuckVariant variant = Utils.getRandomOf(child.getRandom(), this, parent2).getVariant();
    ...
    @Override
    public CommonRegistry<DuckVariant> variantRegistry() {
        return FPBuiltInRegistries.DUCK_VARIANT.get();
    }
    ...
    public DuckVariant defaultVariant() {
        return DuckVariant.GREEN_HEADED.get();
    }
