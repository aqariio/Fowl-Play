...
public class GooseEntity extends TrustingBirdEntity implements BirdBrain<GooseEntity>, VariantHolder<GooseVariant>, Domesticatable, Flocking {
    ...
    public SpawnGroupData finalizeSpawn(
        ...
        return super.finalizeSpawn(level, difficulty, spawnType, spawnGroupData, entityNbt);
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel level, AgeableMob otherParent) {
        ...
        if(child != null && otherParent instanceof GooseEntity parent2) {
            GooseVariant variant = Utils.getRandomOf(child.getRandom(), this, parent2).getVariant();
            child.setVariant(variant);
            child.setDomestic(variant.domesticatable());
        }
        return child;
    }
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DOMESTIC, false);
        this.defineVariant(this.entityData, VARIANT);
    }

    @Override
    public CommonRegistry<GooseVariant> variantRegistry() {
        return FPBuiltInRegistries.GOOSE_VARIANT.get();
    }
    ...
    @Override
    public GooseVariant defaultVariant() {
        return GooseVariant.CANADA.get();
    }
    ...
    protected SoundEvent getCallSound() {
        if(this.getVariant().equals(GooseVariant.GREYLAG.get())) {
            return FPSoundEvents.GREYLAG_GOOSE_CALL.get();
        }
        if(this.getVariant().equals(GooseVariant.SWAN.get())) {
