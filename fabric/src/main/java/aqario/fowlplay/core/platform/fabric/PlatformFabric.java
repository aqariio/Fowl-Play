...
import aqario.fowlplay.client.fabric.RenderRegistryImpl;
...
import aqario.fowlplay.common.registry.fabric.*;
import aqario.fowlplay.common.worldgen.fabric.BiomeModifierImpl;
...
public class PlatformFabric implements PlatformHelper {
    @Override
