...
public class FowlPlayBiomeTagGen extends FabricTagProvider<Biome> {
    ...
    private static final Identifier IS_COLD_OVERWORLD = Identifier.of("forge", "is_cold/overworld");
    private static final Identifier IS_SPARSE_OVERWORLD = Identifier.of("forge", "is_sparse/overworld");
    private static final Identifier IS_DENSE_OVERWORLD = Identifier.of("forge", "is_dense/overworld");
    private static final Identifier IS_CONIFEROUS = Identifier.of("forge", "is_coniferous");
