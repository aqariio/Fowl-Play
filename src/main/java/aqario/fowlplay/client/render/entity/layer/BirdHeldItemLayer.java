...
import aqario.fowlplay.client.render.entity.model.OldBirdModel;
...
public class BirdHeldItemLayer<E extends BirdEntity, M extends OldBirdModel<E>> extends RenderLayer<E, M> {
