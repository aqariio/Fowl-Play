...
public class VultureModel extends OldFlyingBirdModel<VultureEntity> {
    public static final ModelLayerLocation MODEL_LAYER = new ModelLayerLocation(FowlPlay.id("vulture"), "main");
    ...
    @Override
    protected void setAnimations(VultureEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float relativeHeadYaw, float headPitch, float partialTick) {
        if(entity.isFlying()) {
    ...
    @Override
    protected boolean shouldRenderWings(VultureEntity entity) {
