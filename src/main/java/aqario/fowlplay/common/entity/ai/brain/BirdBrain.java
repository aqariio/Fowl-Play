...
public interface BirdBrain<E extends Animal & BirdBrain<E>> extends SmartBrainOwner<E> {
    ...
    @SafeVarargs
    static <T extends Animal & BirdBrain<T>> BrainActivityGroup<T> core(Behavior<? super T>... behaviours) {
        return new BrainActivityGroup<T>(Activity.CORE).priority(0).behaviours(behaviours);
    }

    @SafeVarargs
    static <T extends Animal & BirdBrain<T>> BrainActivityGroup<T> avoid(Behavior<? super T>... behaviours) {
    ...
    @SafeVarargs
    static <T extends Animal & BirdBrain<T>> BrainActivityGroup<T> deliver(Behavior<? super T>... behaviours) {
    ...
    @SafeVarargs
    static <T extends Animal & BirdBrain<T>> BrainActivityGroup<T> fight(Behavior<? super T>... behaviours) {
    ...
    @SafeVarargs
    static <T extends Animal & BirdBrain<T>> BrainActivityGroup<T> follow(Behavior<? super T>... behaviours) {
    ...
    @SafeVarargs
    static <T extends Animal & BirdBrain<T>> BrainActivityGroup<T> forage(Behavior<? super T>... behaviours) {
        return new BrainActivityGroup<T>(FPActivities.FORAGE.get()).priority(10).behaviours(behaviours);
    }

    @SafeVarargs
    static <T extends Animal & BirdBrain<T>> BrainActivityGroup<T> hunt(Behavior<? super T>... behaviours) {
        return new BrainActivityGroup<T>(FPActivities.HUNT.get()).priority(10).behaviours(behaviours);
    }

    @SafeVarargs
    static <T extends Animal & BirdBrain<T>> BrainActivityGroup<T> idle(Behavior<? super T>... behaviours) {
        return new BrainActivityGroup<T>(Activity.IDLE).priority(10).behaviours(behaviours);
    }

    @SafeVarargs
    static <T extends Animal & BirdBrain<T>> BrainActivityGroup<T> pickUp(Behavior<? super T>... behaviours) {
    ...
    @SafeVarargs
    static <T extends Animal & BirdBrain<T>> BrainActivityGroup<T> rest(Behavior<? super T>... behaviours) {
        return new BrainActivityGroup<T>(Activity.REST).priority(10).behaviours(behaviours);
    }

    @SafeVarargs
    static <T extends Animal & BirdBrain<T>> BrainActivityGroup<T> soar(Behavior<? super T>... behaviours) {
