...
public final class FPItemTags {
    public static final TagKey<Item> BIRD_FEED = create("bird_feed");
    ...
    public static final TagKey<Item> PIGEON_DELIVERABLE = create("pigeon_deliverable");
